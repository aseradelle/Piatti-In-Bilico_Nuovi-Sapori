<?php
  ...
  $sql = "
    CREATE TABLE IF NOT EXISTS anagrafica_Utente (
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $query = "SELECT * FROM anagrafica_Utente WHERE username = '$username' OR email = '$email'";
  ...
  $queryInsert = "INSERT INTO anagrafica_Utente (username, email, password) VALUES ('$username', '$email' , '$hashedPassword')";
